-- Drop existing admin_update_settings functions and create bulletproof RPC functions

-- Drop all versions of admin_update_settings function
DROP FUNCTION IF EXISTS admin_update_settings(NUMERIC, NUMERIC, NUMERIC);
DROP FUNCTION IF EXISTS admin_update_settings(NUMERIC, INTEGER, NUMERIC);
...
-- Function 2: Admin update settings (final bulletproof version)
