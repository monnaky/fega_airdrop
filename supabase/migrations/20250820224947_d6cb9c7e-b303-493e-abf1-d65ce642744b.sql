...
-- First, recreate the increment_profile_tokens function with proper security
DROP FUNCTION IF EXISTS public.increment_profile_tokens(text, integer, integer);
...
-- Recreate the increment_referral_count function with proper security
DROP FUNCTION IF EXISTS public.increment_referral_count(text, integer);
